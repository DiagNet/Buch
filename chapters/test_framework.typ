...
_DiagNetTest_ bildet das Fundament für alle implementierten Tests und kapselt die gesamte Logik zur Testausführung, einschließlich Parameter-Validierung, Abhängigkeitsmanagement und Ergebnisverarbeitung.
...
Jede Methode, die als eigenständiger Testfall ausgeführt werden soll, muss zwingend mit dem Präfix *test\_* beginnen. Methoden ohne dieses Präfix werden vom Discovery-Prozess ignoriert und können als Helper-Methoden genutzt werden.
