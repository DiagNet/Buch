...
#figure(
  image("../assets/WAN.png", width: 100%),
...
Ergänzend zur #htl3r.short[wan]-Infrastruktur beinhaltet die Topologie dedizierte Segmente für Adressübersetzung und hierarchisches Routing.

=== #htl3r.full[nat]
Ein spezialisierter Standort bildet die Schnittstelle zwischen privaten Addressen und dem öffentlichen Adressraum ab.
Dabei kommen drei Verfahren des #htl3r.short[nat] parallel zum Einsatz, um unterschiedliche Übersetzungsszenarien zu simulieren:
